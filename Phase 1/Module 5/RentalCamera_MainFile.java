...
public class RentalCamera_MainFile {
	...
	public static void main(String[] args) {
		...
		cameraList.add(new Camera(14, "Sony", "DSLR12", 200.0, "Available"));
		cameraList.add(new Camera(15, "Samsung", "SM123", 200.0, "Available"));
		cameraList.add(new Camera(16, "Sony", "SONY1234", 123.0, "Available"));
		users.add(new User("naresh", "rao", 10000));
		System.out.println("+-------------------------------------------+");
									...
									try {
										System.out.print("ENTER THE AMOUNT (INR) - ");
												...
												if (userToUpdateWallet != null) {
													...
													System.out.println("YOUR WALLET BALANCE UPDATED SUCCESSFULLY. CURRENT WALLET BALANCE - INR."+ user.getWallet());
												} else {
	...
	private static void rentCamera(String loggedInUser) {
		...
		try {
			...
			System.out.print("ENTER THE CAMERA ID YOU WANT TO RENT -");
					...
					if (getcamera == null) {
						System.out.println("Camera with ID " + cameraCode + 
								" not found.");
						return;
					}
					// Get rental period
					...
					if (rentAmount > userToUpdate.getWallet()) {
						System.out.println("ERROR : TRANSACTION FAILED DUE TO INSUFFIECIENT WALLET BALANCE. PLEASE DEPOSIT THE AMOUNT TO YOUR WALLET.");
								return;
					}
					...
					userToUpdate.getWallet());
						System.out.println("YOUR TRANSACTION FOR CAMERA - " + 
								"with rent INR." + rentAmount + " HAS SUCCESSFULLY COMPLETED.");
	...
	public static int generateCameraId() {
		...
		if (!cameraList.isEmpty()) {
			Camera lastCamera = cameraList.get(cameraList.size() -
					1);
			...
			System.out.println("================================================================");
					...
					System.out.println("=============================================================== ");
							for (int i = 0; i < cameraList.size(); i++) {
								...
								System.out.format("%-10d%-10s%-10s%-18s%s%n", 
