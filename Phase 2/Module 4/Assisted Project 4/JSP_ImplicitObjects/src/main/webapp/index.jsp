<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page errorPage="ass2handle-error.jsp"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	if (responseCheck != null) {
		...
		response.setHeader("Location", "ass2Response-redirect.jsp?office=" + responseCheck);
	}
	...
	pageContext.setAttribute("userid", "nareshrao");
	out.println("userId attribute from pageContext: " + pageContext.getAttribute("userid") + "<br>");
	%>
	<a href="ass2index.jsp?office=head_office">Show usage of response
		object</a>
	<br>
	<a href="ass2index.jsp?error=1">Show usage of error object</a>
	<br>
	<%
